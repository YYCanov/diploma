...
*Инфраструктура и ПО развертывается Terraform и Ansible - не требуется дол. действий, только terraform apply.*  

Параметры виртуальной машины (ВМ) подбирайте по потребностям сервисов, которые будут на ней работать.

*В учебных целях создавались ВМ с минимальными требованиями, прерываемые, с гарантированной долей цепу 20% - последние два параметра вынесены в переменные терраформа.*  
...
*ВМ в варианте с тремя веб серверами - количество машин за alb задается в переменных.* 
